...
const Portfolio = () => {
  ...
  return (
    <div
      name="portfolio"
      className="bg-gradient-to-b from-black via-black to-stone-700 w-full text-white md:h-screen"
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-12 sm:px-0">
          {portfolios.map(({ id, src }) => (
            <div
              key={id}
              className="shadow-md shadow-red-600 rounded overflow-scroll overflow-x-hidden overflow-y-hidden hover:overflow-y-auto h-[180px] hover:cursor-grab"
            >
              <img
                src={src}
                alt=""
              ...
              <div className="flex items-center justify-center sticky gap-2 bottom-[-1px]">
                <button className="w-1/2 px-4 py-2 duration-200 bg-black rounded-lg hover:bg-red-600 hover:scale-105">
                  Demo
                </button>
                <button className="w-1/2 px-4 py-2 duration-200 bg-black rounded-lg hover:bg-red-600 hover:scale-105">
                  Code
